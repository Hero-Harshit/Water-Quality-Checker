...
let check_now_btn = document.getElementById("check_button");
...
if (!sessionStorage.getItem("current_mode")) {
    sessionStorage.setItem ("current_mode", "Academia Authorative");
}
...
document.addEventListener("DOMContentLoaded" , check_mode);
